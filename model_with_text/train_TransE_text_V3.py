...
pipeline(    
    ...
    training_kwargs= {
      "batch_size": 512,
      "num_epochs": 580,
      "checkpoint_name": 'checkpoint_transe_text_V3.pt',
      "checkpoint_frequency": 1,
      "checkpoint_directory": "./checkpoint_transe_text_V3",
    },
    ...
    validation= validation).save_model("./checkpoint_transe_text_V3/checkpoint_transe_text_V3.pkl")
