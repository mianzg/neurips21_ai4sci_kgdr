...
pipeline(    
    ...
    training_kwargs= {
      "batch_size": 512,
      "num_epochs": 800,
      "checkpoint_name": 'checkpoint_proje_text_V0.pt',
      "checkpoint_frequency": 1,
      "checkpoint_directory": "./checkpoint_proje_text_V0",
    },
    ...
    validation= validation).save_model("./checkpoint_proje_text_V0/proje_text.pkl")
