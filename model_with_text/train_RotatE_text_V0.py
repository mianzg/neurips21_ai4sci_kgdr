...
pipeline(    
    ...
    training_kwargs= {
      "batch_size": 512,
      "num_epochs": 520,
      "checkpoint_name": 'checkpoint_rotate_text_V0.pt',
      "checkpoint_frequency": 1,
      "checkpoint_directory": "./checkpoint_rotate_text_V0",
    },
    ...
    validation= validation).save_model("./checkpoint_rotate_text_V0/checkpoint_rotate_text_V0.pkl")
