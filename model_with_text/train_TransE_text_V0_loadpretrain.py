...
from pykeen.models.multimodal import TransEText

model = TransEText(triples_factory=training,embedding_dim=285)
model.load_state_dict(torch.load("transe_state_only.pkl",map_location='cpu'), strict=False)
...
pipeline(    
    ...
    training_kwargs= {
      "batch_size": 512,
      "num_epochs": 580,
      "checkpoint_name": 'checkpoint_transe_text_V0_withpretrain.pt',
      "checkpoint_frequency": 1,
      "checkpoint_directory": "./checkpoint_transe_text_V0_withpretrain",
    },
    ...
    validation= validation).save_model("./checkpoint_transe_text_V0_withpretrain/checkpoint_transe_text_V0_withpretrain.pkl")
